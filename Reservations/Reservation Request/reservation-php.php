    ...
    <body>
        <div class="container">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                 ...
                 <div class="messages"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="form_lastname">Date/Time *</label>
                                        <input id="form_lastname" type="datetime-local" name="datetime" class="form-control" required="required">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>
            ...
            if(isset($_POST['ok'])){
                ...
                $obj=new Contact();
                $res=$obj->reservation_request($_POST);
